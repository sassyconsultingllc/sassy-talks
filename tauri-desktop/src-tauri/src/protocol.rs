...
// CodeMark: SCLLC1-sassytalkie-BKDFEB7UBZ2S
...
impl Packet {
    ...
    pub fn discovery_with_key(
        ...
        let packet = Self {
            version: Self::VERSION,
            device_id,
            packet_type: PacketType::DiscoveryWithKey {
                device_name,
                channel,
                public_key,
            },
    ...
    pub fn encrypted_audio(
        ...
        let packet = Self {
            version: Self::VERSION,
            device_id,
            packet_type: PacketType::EncryptedAudio {
                channel,
                nonce,
                auth_tag,
                data,
...
mod tests {
    ...
    fn test_encrypted_audio_packet() {
        ...
        if let PacketType::EncryptedAudio {
            channel,
            nonce: n,
            auth_tag,
            data: d,
