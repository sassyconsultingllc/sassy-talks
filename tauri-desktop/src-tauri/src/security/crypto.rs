...
// CodeMark: SCLLC1-sassytalkie-K5DQVT6SYKL2
...
impl CryptoEngine {
    ...
    pub fn encrypt(
        ...
        let cipher = self.cipher.as_ref().ok_or(CryptoError::EncryptionFailed)?;
    ...
    pub fn decrypt(
        ...
        let cipher = self.cipher.as_ref().ok_or(CryptoError::DecryptionFailed)?;
